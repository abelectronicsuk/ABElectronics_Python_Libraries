...
def main():
    ...
    try:
        iobus.set_port_direction(0, 256)
        pass
    except ValueError:
    ...
    for x in range(0, 256):
        iobus.set_port_direction(0, x)
        iobus.set_port_direction(1, x)
