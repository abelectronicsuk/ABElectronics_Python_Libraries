...
class ADCDACPi:
  ...
  def setADCrefvoltage(self, voltage):
      ...
      # The ADC uses the raspberry pi 3.3V power as a voltage reference so using this method to set the reference to match the 
      # exact output voltage from the 3.3V regulator will increase the accuracy of the ADC readings.
