...
"""
================================================
AB Electronics UK IO Pi Tests | set_interrupt_on_bus

Requires python smbus to be installed
For Python 2 install with: sudo apt-get install python-smbus
For Python 3 install with: sudo apt-get install python3-smbus

run with: python3 set_interrupt_on_bus.py
================================================

This test validates the set_interrupt_on_bus function in the IOPi class.
...
def main():
    ...
    # Check set_interrupt_on_bus value for low out-of-bounds
    try:
        iopi.set_interrupt_on_bus(-1)
        pass
    except ValueError:
    ...
    # Check set_interrupt_on_bus value for high out-of-bounds
    try:
        iopi.set_interrupt_on_bus(65536)
        pass
    except ValueError:
