...
"""
================================================
AB Electronics UK IO Pi Tests | test get_interrupt_defaults function

Requires python smbus to be installed
For Python 2 install with: sudo apt-get install python-smbus
For Python 3 install with: sudo apt-get install python3-smbus

run with: python3 get_interrupt_defaults.py
================================================

This test validates the get_interrupt_defaults function in the IOPi class.

=== Expected Result ============================

> Console Output:

get_interrupt_defaults() low boundary check: PASSED
get_interrupt_defaults() high boundary check: PASSED
Test Passed
