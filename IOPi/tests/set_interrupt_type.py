...
"""
================================================
ABElectronics IO Pi Tests | set_interrupt_type
...
def main():
    ...
    # Check set_interrupt_type port for low out of bounds
    try:
        iopi.set_interrupt_type(-1, 0)
        pass
    except ValueError:
    ...
    # Check set_interrupt_type port for high out of bounds
    try:
    ...
    # Check set_interrupt_type value for low out of bounds
    try:
        iopi.set_interrupt_type(0, -1)
        pass
    except ValueError:
    ...
    # Check set_interrupt_type value for high out of bounds
    try:
        iopi.set_interrupt_type(0, 256)
        pass
    except ValueError:
